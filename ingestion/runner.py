...
class IngestionRunner:
    ...
    def run_single(self, config: Dict[str, Any]) -> None:
        ...
        if driver_type == 'csv':
            ...
            print(f"  WARNING: PDF driver not yet implemented")
        elif driver_type == 'api':
            print(f"  WARNING: API driver not yet implemented")
        else:
    ...
    def _write_output(self, config: Dict[str, Any], transactions: List[Dict[str, Any]], 
                      importer: GenericCSVImporter) -> None:
        """
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='SFIS Ingestion Runner - Import financial data'
    )
    parser.add_argument(
        '--config-dir',
    ...
    parser.add_argument(
        '--data-dir',
        default='data',
        help='Directory containing source data files to import'
    )
    parser.add_argument(
        '--output-dir',
        default='ledger/includes',
        help='Directory to write Beancount output files'
    )
